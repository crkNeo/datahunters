...
const query = `(Trump OR "Elon Musk" OR "Federal Reserve" OR "interest rate" OR inflation OR tariff OR sanctions OR war OR ceasefire OR bitcoin OR ethereum OR cryptocurrency) sourcelang:english`
