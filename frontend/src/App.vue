...
const microMeta = {
  ...
  ema2155: {
    ...
    help: '<b>只做多的順勢策略</b>——EMA21 上穿 EMA55（金叉)進場。<br><b>三個週期同頁</b>:<b>1H / 4H / 日線</b>各自獨立掃描、獨立持倉(同一幣可在不同週期各開一單),列表以「<b>週期</b>」欄分類。<br><b>進場</b>:該週期收盤出現 <b>EMA21 金叉 EMA55</b> → 收盤市價做多。<br><b>止損</b>:金叉當下<b>近 20 根 K 棒的最低點</b>(此距離為 1R)。<br><b>止盈(三價位)</b>:<b>TP1 = 固定 +5%</b>、<b>TP2 = 1:1(1R)</b>、<b>最終 = 1:2(2R)</b>。<br>　若 <b>1:1 小於 5%</b>(止損很近),則 <b>TP1 / TP2 自動對調</b>(較近的當 TP1)。<br><b>分批比例</b>:TP1 平 40%→止損移保本、TP2 平 30%→止損移 TP1、最終平剩餘 30%。<br><b>反向出場</b>:持倉過程中若出現 <b>EMA21 死叉 EMA55</b> → 該根收盤<b>即時平倉</b>。<br>無固定時間出場;冷卻 4 根。<br><br>管理員專屬模擬單,⚠️ 非投資建議。',
  },
  pulsar: {
